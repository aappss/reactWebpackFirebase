                    ...
                    <MDBCol md="5" className="offset-md-3">
                        <MDBCard>
                            <MDBCardBody className="mx-4">
                                ...
                                <MDBInput label="Your email" group type="text" validate name="email" value={this.state.email} onChange={this.onChange} />
                                ...
                                <MDBRow className="d-flex align-items-center mb-4">
                                    <MDBCol md="6" className="text-center">
                                        <button type="button" disabled={isInvalid} onClick={this.onSubmit} className="btn btn-pink btn-block btn-rounded z-depth-1"> Sign In </button>
                                    </MDBCol>
